"""
Parse GenBank, build local JSON database
"""
...
class DB:
    ...
    def _from_db(self, database):
        ...
        This function loops over organism entries in the JSON database, and instantiates
        namedtuples (defined as DB class variables) for Organism, Scaffold and Protein
        entries.
        """
...
def diamond_makedb(fasta, name):
    ...
    print(f"diamond database will be written to: {name}.dmnd")
    subprocess.run(
