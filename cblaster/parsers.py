...
def add_dereplicating_group(search):
    ...
    group.add_argument(
        ...
        type = str,
        default = "dereplication",
        help = "Path to the temporary work folder for the dereplication"
    )
    group.add_argument(
        '-c',
        '--cores',
        type = int,
        default = 1,
        help= "The number of cores to use for the dereplication"
    )
    group.add_argument(
        '--keep_dereplication_files',
        action = "store_true",
        default= False,
        help = "Whether all temporary files generated by cagecleaner need to be kept"
    )
    group.add_argument(
        '--keep_dereplication_reports',
        action="store_true",
        default=False,
        help = "Whether all report files generated by cagecleaner need to be kept"
    )
    group.add_argument(
        '-a',
        '--ani',
    ...
    group.add_argument(
        ...
        action = "store_true",
        default = False,
        help = "Skip recovering hits by cluster content"
    )
    group.add_argument(
        '--no_recovery_score',
        action = "store_true",
        default = False,
        help = "Skip recovering hits by outlier scores"
    )
    group.add_argument(
        '--min_z_score',
        type = float,
