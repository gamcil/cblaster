...
extract_clusters_frame = sg.Frame(
    ...
    layout=[
        ...
        [TextLabel("Clusters"), sg.InputText(key="clusters")],
        ...
        [TextLabel("Score threshold"), sg.InputText(key="score threshold")],
        ...
        [TextLabel("Maximum clusters"), sg.InputText(key="max clusters", default_text="50")],
        [sg.Text(
