...
input_frame = Frame(
    ...
    layout=[
        ...
        [TextLabel("Session file"),
         ...
         sg.FileSaveAs(key="session_file")],
    ],
)
...
dereplication_frame = Frame(
    "Dereplication (only active in remote mode)",
    key="dereplication_frame",
    layout=[
        [sg.Text("Specify the options to remove hit redundancy using cagecleaner.")],
        [TextLabel("Enable dereplication"),
         sg.Checkbox("", key="dereplication_check", default = True, enable_events=True)],
        [TextLabel("Temporary work folder"),
         sg.In(key="dereplication_workfolder", size = (28,1)),
         sg.FolderBrowse(key="dereplication_workfolder")],
        [sg.Text("This temporary work folder will contain all files generated by CAGEcleaner. (Default: system temporary folders)",
                 size = (TEXT_WIDTH, 3))],
        [TextLabel("Cores"),
         sg.InputText(default_text="1", key="dereplication_no_cores")],
        [TextLabel("Keep all temp. files"),
         sg.Checkbox("", key = "dereplication_keep_all", default = False)],
        [TextLabel("Keep downloaded genomes"),
         sg.Checkbox("", key = "dereplication_keep_downloads", default = False)],
        [sg.Text("Saved files will be placed in a subfolder 'cagecleaner' at the current work directory.",
                 size = (TEXT_WIDTH, 3))],
        [TextLabel("ANI threshold (%)"),
         sg.InputText('99.0', key = "dereplication_ani")],
        [TextLabel("Recovery by content"),
         sg.Checkbox('', key = "dereplication_content_recovery", default = True)],
        [TextLabel("Recovery by score"),
         sg.Checkbox("", key = "dereplication_score_recovery", default = True)],
        [TextLabel("Min. z-score"),
         sg.InputText(default_text="2.0", key="dereplication_min_z_score")],
        [TextLabel("Min. score difference"),
         sg.InputText(default_text="0.1", key="dereplication_min_score_diff")],
    ],
)
...
summary_frame = Frame(
    ...
    layout=[
        ...
        [TextLabel("Generate summary table"),
         sg.Checkbox("", key="summary_gen", default=False, enable_events=True)],
        [TextLabel("Delimiter"),
