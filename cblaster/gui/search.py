...
dereplication_frame = Frame(
    ...
    layout=[
        ...
        [TextLabel("Dereplicate"),
         sg.Checkbox("", key="dereplication_check", default = True, enable_events=True),
         sg.In(key="dereplication_workfolder", size = (28,1), default_text = "e.g. dereplication"),
         sg.FolderBrowse(key="dereplication_workfolder")],
        [sg.Text("The temporary files generated by cagecleaner will be "
                 "placed at the path specified by the argument above.",
                 size = (TEXT_WIDTH, 3))],
        [TextLabel("Cores"),
